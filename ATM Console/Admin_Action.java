...
public class Admin_Action implements Admin_action {
    ...
    @Override
    public Account login(ArrayList<Account> adminList) {
        Account loggedInAdmin=null; // It is User to store the Admin Object address
    ...
    public void addUser() {
        ...
        if (userExists) {// If that boolean value is true it display that User Already exists
            ...
            Customer newCustomer = new Customer(userId, password, name);// It is Where store for add Account this is an Implicit conversion
            ATM_OP.addCustomer(newCustomer);//it call the add Customer method and pass the argument is newCustomer

            System.out.println("Enter the Initial Amount:");
            new Customer_Action().depositAmt(newCustomer);//it is pass an argument newCustomer for store the store the balance in this customer and explicitly convert the Account to customer
    ...
    @Override
    public void viewAllTransactions() {// It is used to get the Objects stored in Account ArrayList
    ...
    @Override
    public void addATMoney(Admin admin) {
        ...
        if (totalAmount == amount) {
            for (Note note : ATM_OP.getNotes().getAll()) {
                switch (note.getNote()) {
    ...
    @Override
    public void addAdTransaction(Transaction transaction, Admin admin) {
