...
public class ATM_OP {
    ...
    private static Notes<Note> notes = new Notes<Note>();


    // Scanner for user input
    private static final Scanner sc = new Scanner(System.in);
    static Admin_action admin_action=new Admin_Action();
    static Customer_action customer_action=new Customer_Action();
    // Getter for admin list

    // Getter for note list
    public static Notes<Note> getNotes() {
        return notes;
    }
    ...
    public static void setNotes(Notes<Note> notes) {
        ATM_OP.notes = notes;
    }
    ...
    public static void start() throws CloneNotSupportedException {
        ...
        AccDT.add(new Admin("admin","admin123","Gokul"));
        ...
        while (runUser) {
            try {
                ...
                for (Account Acc_cus: getAccDT()) {
                    if (Acc_cus instanceof Customer cust){
